...
class ChecklistPreenchidoDao extends DatabaseAccessor<AppDatabase>
  ...
  Future<ChecklistPreenchidoTableDto?> buscarPorId(int id) async {
    AppLogger.d('Buscando checklist preenchido por ID: $id',
        tag: 'ChecklistPreenchidoDao');
    ...
    try {
      ...
      if (result == null) {
        AppLogger.w('Checklist preenchido não encontrado para ID: $id',
            tag: 'ChecklistPreenchidoDao');
        return null;
      }
      ...
      AppLogger.e('Erro ao buscar checklist preenchido por ID: $e',
          tag: 'ChecklistPreenchidoDao');
      return null;
    }
  }
  ...
  Future<List<ChecklistPreenchidoTableDto>> buscarPorTurno(int turnoId) async {
    AppLogger.d('Buscando checklists preenchidos por turno: $turnoId',
        tag: 'ChecklistPreenchidoDao');
  ...
  Future<List<ChecklistPreenchidoTableDto>> buscarPorModelo(
      int checklistModeloId) async {
    AppLogger.d(
        'Buscando checklists preenchidos por modelo: $checklistModeloId',
        tag: 'ChecklistPreenchidoDao');
  ...
  Future<int> inserir(ChecklistPreenchidoTableDto dto) async {
    ...
    try {
      ...
      AppLogger.i('Checklist preenchido inserido com ID: $id',
          tag: 'ChecklistPreenchidoDao');
      return id;
    } catch (e) {
      AppLogger.e('Erro ao inserir checklist preenchido: $e',
          tag: 'ChecklistPreenchidoDao');
      rethrow;
    }
  }
  ...
  Future<bool> atualizar(ChecklistPreenchidoTableDto dto) async {
    AppLogger.d('Atualizando checklist preenchido ID: ${dto.id}',
        tag: 'ChecklistPreenchidoDao');
    ...
    try {
      ...
      AppLogger.i('Checklist preenchido atualizado: $updated',
          tag: 'ChecklistPreenchidoDao');
      return updated;
    } catch (e) {
      AppLogger.e('Erro ao atualizar checklist preenchido: $e',
          tag: 'ChecklistPreenchidoDao');
      return false;
    }
  }
  ...
  Future<bool> remover(int id) async {
    AppLogger.d('Removendo checklist preenchido ID: $id',
        tag: 'ChecklistPreenchidoDao');
    ...
    try {
      ...
      AppLogger.i('Checklist preenchido removido: $deleted',
          tag: 'ChecklistPreenchidoDao');
      return deleted > 0;
    } catch (e) {
      AppLogger.e('Erro ao remover checklist preenchido: $e',
          tag: 'ChecklistPreenchidoDao');
      return false;
    }
  }
  ...
  Future<int> contarPorTurno(int turnoId) async {
    AppLogger.d('Contando checklists preenchidos por turno: $turnoId',
        tag: 'ChecklistPreenchidoDao');
  ...
  Future<bool> existeParaTurno(int turnoId) async {
    AppLogger.d(
        'Verificando se existe checklist preenchido para turno: $turnoId',
        tag: 'ChecklistPreenchidoDao');
